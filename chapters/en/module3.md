...
If we have more bins for a histogram, the shape may differ from a histogram that uses fewer bins. 
...
Which island tends to have penguins with a higher body mass?
