...
Notes:
In module 2 we discussed how changing the colour scheme drastically improved a clinical outcome
by almost doubling physician's detection rate of blood vessels regions indicative of potential future heart disease 
(from 40% to 70%).

In this slide deck, we will discuss some of the consideration
that goes into evaluating if a colour scheme (also called a colourmap)
