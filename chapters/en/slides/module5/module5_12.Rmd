...
Notes:
In this slide deck you will learn how to select colours that accurately represents your data
...
Notes:
In module 2 we discussed how changing the colourscheme drastically improved a clinical outcome
...
that goes into evaluating if a colourscheme (also called a colourmap)
...
<center><img src="/module5/hsl-cylinder.png" width="90%"></img></center>
...
where different amount of a set of base colours are combined to create all possible colours.
...
cars = data.cars()
chart = (alt.Chart(cars).mark_point(size=70, filled=True).encode(
...
chart_to_save = ((
    chart
    | chart.encode(
    alt.Color('Origin', scale=alt.Scale(scheme='blues'), title=None)))
    .resolve_scale(color='independent'))
chart_to_save.save('../../../../static/module5/charts/categorical-hues.html')
```

<iframe src="/module5/charts/categorical-hues.html" width="100%" height="420px" style="border:none;"></iframe>
...
because it becomes near impossibe to distinguish
