...
To the left you can see a poorly labeled chart.
There y-axis label is not very descriptive,
...
that convey the main take home message of our visualization.
...
Properly used chart and axis titles are a big help for to reach this goal.
...
is is advisable to try to keep all lines about the same length.
...
instead of relying on the legend text and additional coloured lines marks.
...
Here we modify the dataframme we created in the last slide
...
so we can turn off the vertical gridlines by passing `grid=False`
