...
<center><img src="/module5/hsl-questions.png" width="60%"></img></center>
...
how the colours relate the numerical values they represent,
...
chart_to_save = ((chart.encode(alt.Color('Horsepower', title='Engine power (hp)',
                         scale=alt.Scale(scheme='tableau10')))
| chart.encode(alt.Color('Horsepower', title='Engine power (hp)')))
 .resolve_scale(color='independent'))

chart_to_save.save('../../../../static/module5/charts/lightness-vs-hues.html')
```
...
chart_to_save.save('../../../../static/module5/charts/lightness-and-hues.html')
```

<iframe src="/module5/charts/lightness-and-hues.html" width="100%" height="420px" style="border:none;"></iframe>
...
should be at the lightest or darkest end of a sequential colour schemes,
...
for people with the most common colour vision deficiences
...
[this website lets you upload and image and simulate different colour vision deficiencies](https://www.color-blindness.com/coblis-color-blindness-simulator/).
...
This is particularly a negative for people with colour vision deficiencies,
...
including that the sharp transitions between colours introduces visual threshold
