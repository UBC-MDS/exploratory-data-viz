...
and make it easier to see the changes in color
...
to directly compare the colors to the points position on the x-axis.
...
In this slide
we have encoded the weight of the cars as the color.
As we talked about in a previous module,
it is difficult to see exactly which value a color represents,
