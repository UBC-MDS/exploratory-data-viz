...
# Create the pandas DataFrame 
fruit_salad = pd.DataFrame(data, columns = ['name', 'colour', 'location','carbs', 'seed', 'shape', 'sweetness', 'water_content', 'weight' ]) 
fruit_salad
```
...
numeric_features = ['water_content', 'weight']

categorical_features = ['colour', 'location', 'seed', 'shape', 'sweetness']
```
