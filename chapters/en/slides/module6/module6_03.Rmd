...
since this would make it easier to compare the states more precisely.
...
with the figures we are creating in later on in this slide deck.
...
Note where the legends for these plots get placed when we do this;
they are placed to the right of both plots.
...
Now it is clear that they are distinct from the point map,
whereas they has the same blue colour in the previous slide.
