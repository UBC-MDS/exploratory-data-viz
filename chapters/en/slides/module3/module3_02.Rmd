...
Ways to do this include looking at the number of rows in the dataframe,
...
along the x-axis
and making the density area transparaent so that we can see the tick marks.
...
and could instead just have showing the individual observations
...
are there 0.08 observations at 110?
