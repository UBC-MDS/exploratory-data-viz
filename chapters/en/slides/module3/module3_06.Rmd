...
Notes:
In this slide deck, we will see how to use density plots
...
As we can see here,
a histogram is not as unbiased of a plot as we might think at first.
Especially if we have few data points,
...
1. Place the bell-shaped bins and add them together as in the animation a few slides ago.
...
there would be a straight line between the start and endpoint,
...
However,
more steps take more computing power since there are more calculations to make.
