...
Notes:
Visualizing data distributions are useful in understanding the measurements
of a variable, as doing this allows us to quickly and easily see the range and
frequency of values that occur.

One of the simplest visualizations to understand a 
distribution of a single dataframe variable
is to plot each individual observations as a point.
...
and we also see wide variation in the length of movies in the plot.
