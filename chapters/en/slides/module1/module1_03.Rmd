...
When learning about data visualization, it is helpful to distinguish between the following two types of plotting philosophies:
...
*imperative* or a *declarative* visualization philosophhy.
...
We can also observe a relationship between the horsepower of a vehicle and the fuel efficiency. It appears thats cars with greater horsepower (the point are a darker shade of blue), are less efficient with their fuel since miles per Gallon is much lower. 
