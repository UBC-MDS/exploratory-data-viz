...
it is helpful to distinguish between *low level* and *high level* plotting packages.
...
focus on plot construction details
such as *how* to implement the visualization in terms of for-loops, low-level drawing commands, etc.
In the pseudocode example in the slide,
image that we have
you can see how we need to loop through the dataframe
