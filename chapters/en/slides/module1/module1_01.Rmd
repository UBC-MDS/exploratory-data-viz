...
Notes: No? What about if I showed you the commonly used numerical summaries of the data? Tough luck, all the summary statistics in the table below are **the same** for each of these four set.
...
Notes: Humans are not good at detecting patterns in raw numbers,
