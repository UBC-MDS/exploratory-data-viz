...
we could also have saved as SVG
...
Another common format is PDF,
which can be a combination of raster images and scalable graphics formats.
`altair_saver` allows you to save as pdf,
but you have to follow specific installation steps in the instructions
we linked to in the last slide.
...
This process is serving the data as a json file
...
for example by shutting down your notebook,
Altair can no longer see the data and no charts will be shown 
the next time you open the notebook,
until you rerun your code.

If you want a static version of the charts to be always visible in the notebook
