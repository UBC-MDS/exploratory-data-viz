...
<script>
    generateQuiz(
        ...
        { 
        '.repeat()': 'You are half right, we specifically said every *numeric* column though.',
        '.repeated() and the argument type="numeric"': 'I think your argument should be called something else.',
        '.repeat() and the argument type="quantitative"': 'Visualizing the data is a crucial part of communicating information about the data.',
        'The argument map="numeric"': 'You are extremely close, but no past tense is needed.'
        },
        '.repeat() and the argument type="quantitative"', 
    );
</script>
