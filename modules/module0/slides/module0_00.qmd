...
title-slide-attributes:
  data-notes: |
    ...
    You can navigate these slides
    by clicking the arrows in the bottom right corner
    or by using the arrow keys on your keyboard.
    You can enter fullscreen mode by pressing **F**
    and leave it with **Esc**.
    More shortcuts can be found by pressing **?**.
---
