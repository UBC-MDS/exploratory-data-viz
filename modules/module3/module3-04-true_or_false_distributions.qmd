...
<script>
    generateQuiz(
        ...
        {
        '.transform_density()': '',
        '.estimate_density()': 'You are right that we use a method for the first step but this is not the right named method.',
        '.transform_density=True': 'Using an argument is not the right type of coding needed.',
        '.estimate_density=True': 'Using an argument is not the right type of coding needed.'
        },
        '.transform_density()',
    );
</script>
