...
spec = strip_bin(solution_dict)
spec_result = strip_bin(result_dict)
...
assert_chart_equal(spec, spec_result)
```
...
if "config" in solution_dict:
    solution_dict["config"].pop("encoding", None)
if "encoding" in solution_dict:
    for channel in solution_dict["encoding"]:
        solution_dict["encoding"][channel].pop("title", None)
        if "scale" in solution_dict["encoding"][channel]:
            solution_dict["encoding"][channel]["scale"].pop("scheme", None)

if "config" in result_dict:
    result_dict["config"].pop("encoding", None)
if "encoding" in result_dict:
    for channel in result_dict["encoding"]:
        result_dict["encoding"][channel].pop("title", None)
