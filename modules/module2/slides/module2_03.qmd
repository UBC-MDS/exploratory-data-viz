...
Why?
Mainly because families around the world are having fewer children.
One of the driving factors behind this change is
that improved living conditions
lead to reduced child mortality
as can be seen in this visualization.

In countries where child mortality is high,
couples generally struggle with predictable family planning,
and women will often give birth to more children to compensate.
...
that play a role in the reduction of the number of children per family.
Particularly the empowerment of women through education,
which has positive second order effects
such as increased use of contraception.
The decline in child labor
has also increased the cost of bringing up children.

If you're interested in knowing more about the world population predictions,
you can use Gapminder's online resources,
for example [this video on population growth](https://www.gapminder.org/answers/how-did-the-world-population-change/)
...
[This article from Our World in Data](https://ourworldindata.org/global-decline-fertility-rate) provides are more in-depth perspective.
:::
