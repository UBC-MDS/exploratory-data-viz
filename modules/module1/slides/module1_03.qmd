...
Altair works with dataframes in the <a href="http://vita.had.co.nz/papers/tidy-data.html" target="_blank">"tidy"</a> format (which we talked about in the <a href="https://ubc-mds.github.io/programming-in-python-for-data-science/" target="_blank">Programming in Python for Data Science course</a>),
