...
points.add_params(select_genre)
```
...
points.add_params(select_genre).encode(
...
points.add_params(select_genre_and_mpaa).encode(
...
.properties(height=50).add_params(select_year))
...
select_year = alt.selection_interval()
lower = base.properties(height=50).add_params(select_year)
