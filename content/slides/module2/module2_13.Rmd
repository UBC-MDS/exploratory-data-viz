...
we could specify one categorical dataframe column each
...
Notes:
So far we have encoded the same dataframe column
in both the facet and colour channels.
...
into groups by colouring according to another dataframe column.
...
it would be worthwhile to try to facet by that dataframe column 
...
and encoding the same dataframe column in both the y and colour channel,
...
When visualizing so many dataframe columns,
