def test():
    ...
    assert "x=" in __solution__, "Make sure you plotting 'body_mass_g' on the X-axis."
    assert "density:Q" in __solution__, "Make sure you are plotting 'density' as quantititave on the X-axis."
