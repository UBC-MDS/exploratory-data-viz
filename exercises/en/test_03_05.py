def test():
    ...
    assert "x=" in __solution__ or "alt.X" in __solution__, "Make sure you are setting the x-axis to 'culmen_depth_mm'."
    assert 'count()' in __solution__, "Make sure you are plotting the count on the y-axis."
    assert "color=" in __solution__ or "alt.Color", "Make sure you are coloring by species."
