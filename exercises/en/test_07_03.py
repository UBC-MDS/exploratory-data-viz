def test():
    ...
    assert 'alt.selection_interval' in __solution__, "Make sure you are creating a selection interval and storing it in a variable called 'brush'."
    ...
    assert not linked_scatter.encoding.x.title.islower(), "Make sure your X-axis title is capitalized."
    ...
    assert len(together_plots.vconcat) == 2, "Make sure you are combining both plots."
    ...
    assert not together_plots.vconcat[1].encoding.y.title.islower(), "Make sure your Y-axis title is capitalized."
